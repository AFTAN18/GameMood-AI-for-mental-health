...
export default function MoodSliders({ values = {}, onChange }: MoodSlidersProps) {
  ...
  const getMoodIntensity = (value: number) => {
  ...
  return (
    <div className="space-y-6">
      {moodDimensions.map((dimension, index) => {
        ...
        const currentValue = localValues[dimension.key as keyof typeof localValues];
